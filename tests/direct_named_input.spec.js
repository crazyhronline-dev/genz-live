...
test('Direct named input guarantees 96px header logo saves to MySQL', async ({ page }) => {
  ...
  console.log('3. Changing Header Logo Height to 96px...');
  await page.fill('input[name="headerLogoHeight"]', '96');
