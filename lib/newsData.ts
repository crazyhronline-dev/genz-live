// GenZ Live — News Data Access Layer
// Acts as the data service layer. Will connect to Prisma/MySQL in production.
// Currently uses mock data matching the Prisma schema structure.
...
export const FEATURED_STORIES: Article[] = [
  {
    ...
    content: `
      <p class="lead">The landscape of software development and AI is experiencing its most seismic transition since the advent of cloud computing. Autonomous AI agents are no longer experimental prototypes—they are becoming core team members in tech startups globally.</p>
  ...
  },
  {
    ...
    content: `<p>India's technology ecosystem has entered a transformative era, driven by world-class engineering talent, robust digital infrastructure, and explosive growth in AI startups.</p>`,
  },
  {
    id: 'f3',
    ...
    content: `<p>Traditional broadcasting is undergoing a permanent shift. Audiences under 30 are turning away from scripted TV broadcasts in favor of live streaming platforms and community-driven discussion rooms.</p>`,
  },
];
...
export const ARTICLES: Article[] = [
  ...
  {
    id: 'a1',
    title: 'Quantum Computing Breakthrough: Quantum Supremacy in Financial Modeling Achieved',
    category: 'tech',
    ...
    content: '<p>Researchers have demonstrated quantum algorithms performing complex portfolio optimization in seconds — a task that previously required days of supercomputer processing.</p>',
  },
  {
    id: 'a2',
  ...
  },
  {
    ...
    content: '<p>Digital creators are building resilient business models away from ad-reliant platforms, leaning into direct subscriber support and micro-subscriptions.</p>',
  },
  {
    id: 'a4',
    ...
    content: '<p>The global gaming tournament reached unprecedented viewership numbers across Twitch, YouTube, and VR broadcast channels.</p>',
  },
  {
    id: 'a5',
    ...
    content: '<p>Premiering at the international film festival, this groundbreaking feature film utilized neural rendering, reducing production costs by 80%.</p>',
  },
  {
    id: 'a6',
    ...
    content: '<p>Immersive 3D spaces and spatial audio are redefining how art is experienced by younger demographics around the globe.</p>',
  },
  {
    id: 'a7',
    ...
    content: '<p>Youth leaders representing 190 countries signed a binding resolution targeting plastic pollution reduction and green job creation programs.</p>',
  },
];
