      ...
      <main className="flex-1 py-12">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-400 text-sm">Search across thousands of articles, topics, and authors</p>
          </div>
              ...
              {results.length > 0 ? (
                <div className="space-y-3">
                  {results.map(article => (
                    ...
                    >
                      <img src={article.image} alt={article.title} className="w-20 h-20 rounded-xl object-cover shrink-0 group-hover:scale-105 transition-transform" />
